...
function translateDescription(id, defaultDescription) {
    const descriptions = {
        ...
        "label-title-only": "Garante que cada elemento do formulário tenha um rótulo visível e não seja rotulado apenas com rótulos ocultos ou com os atributos title ou aria-describedby",
